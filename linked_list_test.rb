...
class ListTest < Minitest::Test
  ...
  def test_it_starts_with_zero_elements
	...
	def test_it_counts_nodes
		...
		list.push("four")
		list.push("five")
		assert_equal list.count, 5
	end

  def test_a_new_list_starts_with_nil_head
    assert_equal nil, RecursiveLinkedList.new.head
  end
  ...
  def test_it_pushes_two_elements
	...
	def test_it_finds_tail_if_head_is_only_node
    head = list.push("pizza")
		assert_equal list.tail, head
	end
    ...
    list.push("lasagna")
    list.push("calzone")
    last = list.push("manicotti")
		assert_equal list.tail, last
		assert_equal list.tail.data, "manicotti"
	end
